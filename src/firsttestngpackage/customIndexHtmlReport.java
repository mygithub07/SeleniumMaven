...
public class customIndexHtmlReport implements IReporter{
	
	private static final String TESTNG_RESOURCE_PREFIX = "/resources/";
	  ...
	  public static final String REPORT_HEADER_FILE = "header.txt";
